...
template <uint8_t N> class J4310 : public DMMotorBase<N>
{
  ...
  public:
    ...
    J4310(uint16_t Init_id, const uint8_t (&ids)[N], const uint32_t (&send_idxs_)[N])
        : DMMotorBase<N>(Init_id, ids, send_idxs_, Parameters(-3.14, 3.14, -30, 30, -10, 10, 0.0, 500, 0.0, 5.0))
    {
    }
};

template <uint8_t N> class J4310P : public DMMotorBase<N>
{
  private:
    // // 定义参数生成方法
    // Parameters GetParameters() override
  ...
  public:
     ...
     * @param send_idxs_ 电机发送ID列表
     */
    J4310P(uint16_t Init_id, const uint8_t (&ids)[N], const uint32_t (&send_idxs_)[N])
        : DMMotorBase<N>(Init_id, ids, send_idxs_, Parameters(-3.14, 3.14, -30, 30, -10, 10, 0.0, 500, 0.0, 5.0))
    {
    }
};

template <uint8_t N> class J4340P : public DMMotorBase<N>
{
  private:
    // // 定义参数生成方法
    // Parameters GetParameters() override
  ...
  public:
     ...
     * @param send_idxs_ 电机发送ID列表
     */
    J4340P(uint16_t Init_id, const uint8_t (&ids)[N], const uint32_t (&send_idxs_)[N])
        : DMMotorBase<N>(Init_id, ids, send_idxs_, Parameters(-3.14, 3.14, -30, 30, -10, 10, 0.0, 500, 0.0, 5.0))
    {
    }
};
...
template <uint8_t N> class J6006 : public DMMotorBase<N>
{
  private:
    // // 定义参数生成方法
    // Parameters GetParameters() override
  ...
  public:
     ...
     * @param ids 电机ID列表
     */
    J6006(uint16_t Init_id, const uint8_t (&ids)[N], const uint32_t (&send_idxs_)[N])
        : DMMotorBase<N>(Init_id, ids, send_idxs_, Parameters(-12.56, 12.56, -20, 20, -3, 3, 0.0, 500, 0.0, 11.0))
    {
    }
};

template <uint8_t N> class J8009P : public DMMotorBase<N>
{
  private:
    // // 定义参数生成方法
    // Parameters GetParameters() override
  ...
  public:
     ...
     * @param send_idxs_ 电机发送ID列表
     */
    J8009P(uint16_t Init_id, const uint8_t (&ids)[N], const uint32_t (&send_idxs_)[N])
        : DMMotorBase<N>(Init_id, ids, send_idxs_, Parameters(-3.14, 3.14, -45, 45, -54, 54, 0.0, 500, 0.0, 5.0))
    {
    }
};
/**
...
//inline J6006<1> Motor6006(0x00, {1}, {2});
inline J4310<1> Motor4310(0x00, {5}, {6});
