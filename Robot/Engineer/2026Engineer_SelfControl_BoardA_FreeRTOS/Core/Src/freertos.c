...
/* Definitions for hostserial */
osThreadId_t hostserialHandle;
const osThreadAttr_t hostserial_attributes = {
  .name = "hostserial",
  .stack_size = 512 * 4,
...
extern void ArmTask(void *argument);
extern void RemoteTask(void *argument);
extern void HostSerial(void *argument);
...
void MX_FREERTOS_Init(void) {
  ...
  /* creation of hostserial */
  hostserialHandle = osThreadNew(HostSerial, NULL, &hostserial_attributes);
